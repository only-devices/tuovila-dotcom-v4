                ...
                {book.rating > 0 && (
                  <div className="flex items-center mt-1">
                    {[...Array(5)].map((_, i) => {
                      if (book.rating >= i + 1) {
                        return (
                          <StarIcon key={i} className="text-yellow-500 dark:text-yellow-400" />
                        );
                      }
                      if (book.rating > i) {
                        return (
                          <div key={i} className="relative w-4 h-4">
                            ...
                            <div
                              ...
                              style={{ width: `${(book.rating - i) * 100}%` }}
                            >
                              <StarIcon className="text-yellow-500 dark:text-yellow-400" />
                            </div>
                          </div>
                        );
                      }
                      return (
                        <StarIcon key={i} className="text-gray-300 dark:text-gray-600" />
                      );
                    })}
                  </div>
                )}
